/*
 * Listed first are ucode token categories for which there is no
 * corresponding entry in Unicon's opdefs.h.  They are given #'s
 * above 200. Numbers below 200 are generally opcodes of instructions
 * and pseudo-instructions from the real Unicon implementation.
 */

#define VERSIONSTAMP 202
#define UCODESTAMP 204
#define DECCONST 208       /* decimal integer literal constant */
#define COMMA 209
#define OCTCONST 210
#define IDENTIFIER 211
#define CONTROL_L 212
#define REALCONST 215
#define FILENAME 218
#define LABEL 223
#define ANY 227

/*
 * From here on out, you are looking at the real opdefs.h from Unicon.
 * Lexically, for the most part you just remove the "Op_" and shift the
 * remainder to all lowercase, thus Op_Asgn is returned when asgn is seen.
 */
...
#define Op_Any	 	 300
#define Op_Case	 	 301
#define Op_Endcase 	 302
#define Op_Every 	 303
#define Op_Endevery 	 304
#define Op_If	 	 305
#define Op_Endif 	 306
#define Op_Ifelse	 307
#define Op_Endifelse	 308
#define Op_Repeat	 309
#define Op_Endrepeat	 310
#define Op_Suspend	 311
#define Op_Endsuspend	 312
#define Op_Until	 313
#define Op_Enduntil 	 314
#define Op_While	 315
#define Op_Endwhile 	 316
*/
